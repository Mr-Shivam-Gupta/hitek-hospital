                  ...
                  <form id="" method="post" action="submit-appointment" class="row">
                     ...
                     <div class="form-group col-sm-6">
                        ...
                        <select class="form-control" name="department_id">
                           <option value="<?php echo $dep_name->department_id;?>" selected=""><?php echo ucwords($dep_name->department_name);?></option>
                        </select>
                     </div>
                     <input type="hidden" name="consultancy" value="<?php echo $dep_name->consultancy;?>">
                     <div class="form-group col-sm-6">
                        <label>Consultant  <span class="text_denger">*</span></label>
                        <select class="form-control" name="doctor_id">
                           <option value="<?php echo $dep_name->id;?>" selected=""><?php echo ucwords($dep_name->doctor_name);?></option>
                        </select>
                     </div>
                     <div class="form-group col-sm-6">
