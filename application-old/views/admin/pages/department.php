                                        ...
                                        <table id="example1" class="table table-bordered table-striped table-hover data_list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php  if ($depList['status']==0)
                                                    {?>
                                                  ...
                                                  <?php
                                                     ...
                                                     <td class="text-center">
                                                            ...
                                                            <a href="#" class="btn btn-info dep-edit" data-id="<?php echo $depList['id'];?>" data-toggle="modal" data-target="#modal-edit-department"><i class="fas fa-pen"></i>E</a>
