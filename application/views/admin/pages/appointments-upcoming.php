         ...
         <div class="col-12">
            <div class="card">
               <div class="card-header">
                  <h3 class="card-title">Upcoming Appointment Details</h3>
               </div>
               <div class="card-body">
                           ...
                           <tbody>
                              ...
                              <tr>
                                ...
                                <!-- <td><?php echo $appointmentReport['consultancy']?></td> -->
                                 ...
                                 <td>
                                    <a href="<?php echo base_url('admin/deleteAppointmentUp/').$appointmentReport['id'];?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                 </td>
                              </tr>
                              <?php endforeach ?>
                           </tbody>
